<template>
  ...
  <aside class="menu">
    ...
    <!--Search contents-->
    <p class="menu-label has-text-weight-bold has-text-danger"> Filter </p>
    <div class="field">
    ...
    <p class="menu-label has-text-weight-bold has-text-danger" v-if="sourceInfo"> Information Source </p>
